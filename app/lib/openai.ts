...
- If asked anything outside domain, politely decline and say I can only answer questions about Usman's experience, projects, and skills.
...
- If information cannot be determined, use Previous Messages to answer if unable to answer from previous messages, reply: "I don't have relevant information to answer that question."
`,
      },
